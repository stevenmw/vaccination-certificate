                        ...
                        <div class="col-lg">
                            <div class="p-5">
                                ...
                                <form action="<?= route_to('register') ?>" method="post" class="user">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-user  <?php if (session('errors.NIK_user')) : ?>is-invalid<?php endif ?>" name="NIK_user " placeholder="<?= lang('NIK') ?>" value="<?= old('NIK_user') ?>">
                                    </div>
